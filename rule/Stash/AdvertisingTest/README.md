...
- AdvertisingTest_Domain.txt，请使用 behavior: domain-text。
- URL-REGEX类型的规则，在HTTPS协议中，需要配合MITM使用。规则生成器已尝试推导MITM的配置AdvertisingTest_MITM.stoverride，仅供参考。
...
https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Stash/AdvertisingTest/AdvertisingTest_Classical.yaml
...
https://cdn.jsdelivr.net/gh/blackmatrix7/ios_rule_script@master/rule/Stash/AdvertisingTest/AdvertisingTest_Classical.yaml
...
https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/release/rule/Stash/AdvertisingTest/AdvertisingTest_Classical.yaml
...
https://cdn.jsdelivr.net/gh/blackmatrix7/ios_rule_script@release/rule/Stash/AdvertisingTest/AdvertisingTest_Classical.yaml

https://cdn.jsdelivr.net/gh/blackmatrix7/ios_rule_script@release/rule/Stash/AdvertisingTest/AdvertisingTest_Domain.txt
