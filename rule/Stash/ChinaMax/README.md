...
- ChinaMax_Domain.txt，请使用 behavior: domain-text。
- ChinaMax_IP.txt，请使用 behavior: ipcidr-text。

#### 文件区别
- ChinaMax_Classical.yaml与ChinaMax_Classical_No_IPv6.yaml的区别在于后者不含IPv6规则，适用纯IPv4网络。
- ChinaMax_IP.txt与ChinaMax_IP_No_IPv6.txt的区别在于后者不含IPv6规则，适用纯IPv4网络。

#### 配置建议
- ChinaMax_Classical.yaml 单独使用。
- ChinaMax_Classical_No_IPv6.yaml 纯IPv4网络，单独使用。
- ChinaMax.yaml、ChinaMax_Domain.txt、ChinaMax_IP.txt 共同使用。
- ChinaMax.yaml、ChinaMax_Domain.yaml、ChinaMax_IP_No_IPv6.yaml 纯IPv4网络，共同使用。

#### 规则链接
**MASTER分支 (每日更新)**

https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Stash/ChinaMax/ChinaMax.yaml

https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Stash/ChinaMax/ChinaMax_Classical.yaml

https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Stash/ChinaMax/ChinaMax_Classical_No_IPv6.yaml

https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Stash/ChinaMax/ChinaMax_Domain.txt

https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Stash/ChinaMax/ChinaMax_IP.txt

https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Stash/ChinaMax/ChinaMax_IP_No_IPv6.txt

**MASTER分支 CDN (每日更新)**

https://cdn.jsdelivr.net/gh/blackmatrix7/ios_rule_script@master/rule/Stash/ChinaMax/ChinaMax.yaml

https://cdn.jsdelivr.net/gh/blackmatrix7/ios_rule_script@master/rule/Stash/ChinaMax/ChinaMax_Classical.yaml

https://cdn.jsdelivr.net/gh/blackmatrix7/ios_rule_script@master/rule/Stash/ChinaMax/ChinaMax_Classical_No_IPv6.yaml

https://cdn.jsdelivr.net/gh/blackmatrix7/ios_rule_script@master/rule/Stash/ChinaMax/ChinaMax_Domain.txt

https://cdn.jsdelivr.net/gh/blackmatrix7/ios_rule_script@master/rule/Stash/ChinaMax/ChinaMax_IP.txt

https://cdn.jsdelivr.net/gh/blackmatrix7/ios_rule_script@master/rule/Stash/ChinaMax/ChinaMax_IP_No_IPv6.txt

**RELEASE分支 (不定时更新)**

https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/release/rule/Stash/ChinaMax/ChinaMax.yaml

https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/release/rule/Stash/ChinaMax/ChinaMax_Classical.yaml

https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/release/rule/Stash/ChinaMax/ChinaMax_Classical_No_IPv6.yaml

https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/release/rule/Stash/ChinaMax/ChinaMax_Domain.txt

https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/release/rule/Stash/ChinaMax/ChinaMax_IP.txt

https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/release/rule/Stash/ChinaMax/ChinaMax_IP_No_IPv6.txt

**RELEASE分支CDN (不定时更新)**

https://cdn.jsdelivr.net/gh/blackmatrix7/ios_rule_script@release/rule/Stash/ChinaMax/ChinaMax.yaml

https://cdn.jsdelivr.net/gh/blackmatrix7/ios_rule_script@release/rule/Stash/ChinaMax/ChinaMax_Classical.yaml

https://cdn.jsdelivr.net/gh/blackmatrix7/ios_rule_script@release/rule/Stash/ChinaMax/ChinaMax_Classical_No_IPv6.yaml

https://cdn.jsdelivr.net/gh/blackmatrix7/ios_rule_script@release/rule/Stash/ChinaMax/ChinaMax_Domain.txt

https://cdn.jsdelivr.net/gh/blackmatrix7/ios_rule_script@release/rule/Stash/ChinaMax/ChinaMax_IP.txt

https://cdn.jsdelivr.net/gh/blackmatrix7/ios_rule_script@release/rule/Stash/ChinaMax/ChinaMax_IP_No_IPv6.txt
