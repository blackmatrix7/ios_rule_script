...
## MITM
白名单分流规则中含有URL-REGEX类型，此类的规则对于HTTPS请求需要使用MITM才能生效。
...
本项目的白名单复写规则的数据来自以下链接，通常已涵盖所有数据来源的复写规则。

如果你正在使用这些复写规则，建议不要与本项目的白名单复写规则混合使用，以免造成规则重复。
